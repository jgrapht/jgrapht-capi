...
/**
 * The median heuristic greedy algorithm for edge crossing minimization in two
 * layered bipartite layouts.
 * 
 ...
 * 
 * The algorithm is described in the following paper: Eades, Peter, and Nicholas
 * C. Wormald. "Edge crossings in drawings of bipartite graphs." Algorithmica
 * 11.4 (1994): 379-403.
 * 
 * The problem of minimizing edge crossings when drawing bipartite graphs as two
 * layered graphs is NP-complete and the median heuristic is a 3-approximation
 * algorithm.
 * 
