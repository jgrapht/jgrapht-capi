...
public class CapiGraphAsMaskSubgraph<V, E> extends CapiGraphDelegator<V, E> implements CapiGraph<V, E> {
	 ...
	 *                   based.
	 * @param vertexMask vertices to exclude in the subgraph. If a vertex is masked,
	 *                   it is as if it is not in the subgraph. Edges incident to
	 *                   the masked vertex are also masked.
	 * @param edgeMask   edges to exclude in the subgraph. If an edge is masked, it
	 *                   is as if it is not in the subgraph.
	 */
	public CapiGraphAsMaskSubgraph(CapiGraph<V, E> base, Predicate<V> vertexMask, Predicate<E> edgeMask) {
		super(base);
	 ...
	 * value returned depends on the type of the underlying graph.
	 */
	@Override
	...
	public Set<E> getAllEdges(V sourceVertex, V targetVertex) {
		if (containsVertex(sourceVertex) && containsVertex(targetVertex)) {
			return new MaskEdgeSet<>(base, base.getAllEdges(sourceVertex, targetVertex), vertexMask, edgeMask);
		} else
			return null;
	}
