...
int main() { 
    ...
    int e;
    assert(jgrapht_capi_ii_graph_add_edge(thread, g, 0, 0, &e) == 0);
    assert(e == 0);
    assert(jgrapht_capi_ii_graph_add_edge(thread, g, 0, 1, &e) == 0);
    assert(e == 1);
    assert(jgrapht_capi_ii_graph_add_edge(thread, g, 0, 2, &e) == 0);
    assert(e == 2);
    ...
    int s, t;
    assert(jgrapht_capi_ii_graph_edge_source(thread, g, 0, &s) == 0);
    assert(jgrapht_capi_ii_graph_edge_target(thread, g, 0, &t) == 0);
    assert(s == 0 && t == 0);
    assert(jgrapht_capi_ii_graph_edge_source(thread, g, 1, &s) == 0);
    assert(jgrapht_capi_ii_graph_edge_target(thread, g, 1, &t) == 0);
    assert(s == 0 && t == 1);
    assert(jgrapht_capi_ii_graph_edge_source(thread, g, 2, &s) == 0);
    assert(jgrapht_capi_ii_graph_edge_target(thread, g, 2, &t) == 0);
    assert(s == 0 && t == 2);
    assert(jgrapht_capi_ii_graph_edge_source(thread, g, 3, &s) == 0);
    assert(jgrapht_capi_ii_graph_edge_target(thread, g, 3, &t) == 0);
    assert(s == 1 && t == 2);
    assert(jgrapht_capi_ii_graph_edge_source(thread, g, 4, &s) == 0);
    assert(jgrapht_capi_ii_graph_edge_target(thread, g, 4, &t) == 0);
    assert(s == 1 && t == 2);
    assert(jgrapht_capi_ii_graph_edge_source(thread, g, 5, &s) == 0);
    assert(jgrapht_capi_ii_graph_edge_target(thread, g, 5, &t) == 0);
    assert(s == 1 && t == 2);
