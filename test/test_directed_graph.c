...
int main() { 
    ...
    // incoming
    assert(jgrapht_graph_indegree_of(g, v1) == 0);
    assert(jgrapht_graph_indegree_of(g, v2) == 2);
    assert(jgrapht_graph_indegree_of(g, v3) == 2);
    assert(jgrapht_graph_indegree_of(g, v4) == 2);
    assert(jgrapht_graph_indegree_of(g, v5) == 2);
    ...
    assert(jgrapht_graph_outdegree_of(g, v2) == 3);
    assert(jgrapht_graph_outdegree_of(g, v3) == 0);
    assert(jgrapht_graph_outdegree_of(g, v4) == 1);
    assert(jgrapht_graph_outdegree_of(g, v5) == 3);
