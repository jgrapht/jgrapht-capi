...
public class CapiGraphAsWeightedGraph<V,E> extends CapiGraphDelegator<V, E> implements CapiGraph<V, E> {
     ...
     */
    public CapiGraphAsWeightedGraph(CapiGraph<V, E> graph, Map<E, Double> weights)
    {
     ...
     */
    public CapiGraphAsWeightedGraph(CapiGraph<V, E> graph, Map<E, Double> weights, boolean writeWeightsThrough)
    {
        super(graph);
     ...
     *         <code>graph</code> is not a weighted graph
     */
    public CapiGraphAsWeightedGraph(
    		CapiGraph<V, E> graph, Function<E, Double> weightFunction, boolean cacheWeights,
