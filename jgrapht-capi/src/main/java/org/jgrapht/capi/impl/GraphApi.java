...
public class GraphApi {
	...
	public static Status createGraph(IsolateThread thread, boolean directed, boolean allowingSelfLoops,
	...
	public static Status verticesCount(IsolateThread thread, ObjectHandle graphHandle, CLongPointer res) {
	...
	public static Status edgesCount(IsolateThread thread, ObjectHandle graphHandle, CLongPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status addVertex(IsolateThread thread, ObjectHandle graphHandle, CLongPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status removeVertex(IsolateThread thread, ObjectHandle graphHandle, long vertex, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status containsVertex(IsolateThread thread, ObjectHandle graphHandle, long vertex, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status addEdge(IsolateThread thread, ObjectHandle graphHandle, long source, long target,
			CLongPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status removeEdge(IsolateThread thread, ObjectHandle graphHandle, long edge, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status containsEdge(IsolateThread thread, ObjectHandle graphHandle, long edge, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status containsEdgeBetween(IsolateThread thread, ObjectHandle graphHandle, long source, long target,
			CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status degreeOf(IsolateThread thread, ObjectHandle graphHandle, long vertex, CLongPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status inDegreeOf(IsolateThread thread, ObjectHandle graphHandle, long vertex, CLongPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status outDegreeOf(IsolateThread thread, ObjectHandle graphHandle, long vertex, CLongPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status edgeSource(IsolateThread thread, ObjectHandle graphHandle, long edge, CLongPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status edgeTarget(IsolateThread thread, ObjectHandle graphHandle, long edge, CLongPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status isWeighted(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status isDirected(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status isUndirected(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status allowSelfLoops(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status allowMultipleEdges(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status allowMultipleEdges(IsolateThread thread, ObjectHandle graphHandle, long edge,
			CDoublePointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status createAllVerticesIterator(IsolateThread thread, ObjectHandle graphHandle, WordPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status createAllEdgesIterator(IsolateThread thread, ObjectHandle graphHandle, WordPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status createEdgesBetweenIterator(IsolateThread thread, ObjectHandle graphHandle, long source,
	...
	public static Status createVertexEdgesOfIterator(IsolateThread thread, ObjectHandle graphHandle, long vertex,
			WordPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status createVertexOutEdgesOfIterator(IsolateThread thread, ObjectHandle graphHandle, long vertex,
			WordPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status createVertexInEdgesOfIterator(IsolateThread thread, ObjectHandle graphHandle, long vertex,
			WordPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
	...
	public static Status asUndirected(IsolateThread thread, ObjectHandle graphHandle, WordPointer res) {
	...
	public static Status asUnmodifiable(IsolateThread thread, ObjectHandle graphHandle, WordPointer res) {
		Graph<Long, Long> gIn = globalHandles.get(graphHandle);
	...
	public static Status asUnweighted(IsolateThread thread, ObjectHandle graphHandle, WordPointer res) {
		Graph<Long, Long> gIn = globalHandles.get(graphHandle);
	...
	public static Status asEdgeReversed(IsolateThread thread, ObjectHandle graphHandle, WordPointer res) {
		Graph<Long, Long> gIn = globalHandles.get(graphHandle);
