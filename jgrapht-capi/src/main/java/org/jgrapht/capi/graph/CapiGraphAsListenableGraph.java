...
public class CapiGraphAsListenableGraph<V, E> extends CapiGraphDelegator<V, E> implements CapiGraph<V, E> {
	...
	public CapiGraphAsListenableGraph(CapiGraph<V, E> graph) {
		super(graph);
	...
	/**
	 * If the <code>reuseEvents</code> flag is set to <code>true</code> this class
	 * will reuse previously fired events and will not create a new object for each
	 * event. This option increases performance but should be used with care,
	 * especially in multithreaded environment.
	 *
	 * @param reuseEvents whether to reuse previously fired event objects instead of
	 ...
	 * <code>true</code> this class will reuse previously fired events and will not
	 * create a new object for each event. This option increases performance but
	...
	protected void fireEdgeRemoved(E edge, V source, V target, double weight) {
		GraphEdgeChangeEvent<V, E> e = createGraphEdgeChangeEvent(GraphEdgeChangeEvent.EDGE_REMOVED, edge, source,
				target, weight);
	...
	protected void fireEdgeWeightUpdated(E edge, V source, V target, double weight) {
		GraphEdgeChangeEvent<V, E> e = createGraphEdgeChangeEvent(GraphEdgeChangeEvent.EDGE_WEIGHT_UPDATED, edge,
