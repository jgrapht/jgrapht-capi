...
public class GraphTestsApi {
	...
	public static Status isEmpty(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
	...
	public static Status isSimple(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status hasSelfLoops(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status hasMultipleEdges(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isComplete(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isWeaklyConnected(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isStronglyConnected(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isTree(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isForest(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isOverfull(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isSplit(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isBipartite(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isCubic(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isEulerian(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isChordal(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isWeaklyChordal(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status hasOreProperty(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isTriangleFree(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isPerfect(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isPlanar(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isKuratowskiSubdivision(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isK33Subdivision(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
	...
	public static Status isK5Subdivision(IsolateThread thread, ObjectHandle graphHandle, CIntPointer res) {
		Graph<Long, Long> g = globalHandles.get(graphHandle);
		if (res.isNonNull()) {
