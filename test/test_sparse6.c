...
int main() {
    ...
    jgrapht_capi_xx_export_file_sparse6(thread, g, "dummy.sparse6.out");
    assert(jgrapht_capi_error_get_errno(thread) == 0);
    ...
    jgrapht_capi_ii_import_file_graph6sparse6(thread, g, "dummy.sparse6.out", import_id, NULL, NULL, NULL, NULL);
    ...
    void *out;
    jgrapht_capi_xx_export_string_sparse6(thread, g, &out);
    char *str;
    jgrapht_capi_handles_get_ccharpointer(thread, out, &str);
    assert(strcmp(str, ":Bd") == 0);
