...
/**
 * Calculates a
 * <a href="http://mathworld.wolfram.com/MinimumVertexColoring.html">minimum
 * vertex coloring</a> for a
 * <a href="https://en.wikipedia.org/wiki/Chordal_graph">chordal graph</a>. A
...
public class ChordalGraphColoring<V, E> implements VertexColoringAlgorithm<V> {
	...
	/**
	 * Creates a new ChordalGraphColoring instance. The {@link ChordalityInspector}
	 * used in this implementation uses the default
	 * {@link MaximumCardinalityIterator} iterator.
	 *
	 * @param graph graph
	 */
	...
	/**
	 * Creates a new ChordalGraphColoring instance. The {@link ChordalityInspector}
	 * used in this implementation uses either the
	 * {@link MaximumCardinalityIterator} iterator or the
	 * {@link LexBreadthFirstIterator} iterator, depending on the parameter
	 * {@code iterationOrder}.
	 *
	 * @param graph          graph
	...
	private void lazyComputeColoring() {
		if (coloring == null && chordalityInspector.isChordal()) {
			...
			Map<V, Integer> vertexColoring = CollectionUtil.newHashMapWithExpectedSize(perfectEliminationOrder.size());
			...
			for (V vertex : perfectEliminationOrder) {
				...
				Set<Integer> predecessorColors = CollectionUtil.newHashSetWithExpectedSize(predecessors.size());
	 ...
	 * Returns a
	 * <a href="http://mathworld.wolfram.com/MinimumVertexColoring.html">minimum
	 * vertex coloring</a> of the inspected {@code graph}. If the graph isn't
	 * chordal, returns null. The number of colors used in the coloring equals the
	 * chromatic number of the input graph.
	 *
	 ...
	 * Returns the <a href=
	 * "https://en.wikipedia.org/wiki/Chordal_graph#Perfect_elimination_and_efficient_recognition">
	 * perfect elimination order</a> used to create the coloring (if one exists).
	 * This method returns null if the graph is not chordal.
	 *
	 * @return the perfect elimination order used to create the coloring, or null if
