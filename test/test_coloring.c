...
int main() {
    ...
    assert(e == 1);
    assert(jgrapht_capi_ii_graph_add_edge(thread, g, 2, 3, &e) == 0);
    assert(e == 2);
    assert(jgrapht_capi_ii_graph_add_edge(thread, g, 3, 0, &e) == 0);
    assert(e == 3);
    assert(jgrapht_capi_ii_graph_add_edge(thread, g, 4, 5, &e) == 0);
    assert(e == 4);
    assert(jgrapht_capi_ii_graph_add_edge(thread, g, 5, 6, &e) == 0);
    assert(e == 5);
    assert(jgrapht_capi_ii_graph_add_edge(thread, g, 6, 7, &e) == 0);
    assert(e == 6);
    assert(jgrapht_capi_ii_graph_add_edge(thread, g, 7, 4, &e) == 0);
    assert(e == 7);
    assert(jgrapht_capi_ii_graph_add_edge(thread, g, 3, 4, &e) == 0);
    assert(e == 8);
    assert(jgrapht_capi_ii_graph_add_edge(thread, g, 5, 3, &e) == 0);
    assert(e == 9);
