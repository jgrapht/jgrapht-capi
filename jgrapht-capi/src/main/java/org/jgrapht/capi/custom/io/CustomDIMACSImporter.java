...
package org.jgrapht.capi.custom.io;
 ...
 *
 * <p>
 * See {@link DIMACSFormat} for a description of all the supported DIMACS
 * formats.
 *
 * <p>
 * In summary, one of the most common DIMACS formats was used in the
 * <a href="http://mat.gsia.cmu.edu/COLOR/general/ccformat.ps">2nd DIMACS
 * challenge</a> and follows the following structure:
 * 
 * <pre>
 * {@code
 * DIMACS G {
 ...
 * Descriptors' are currently not supported (ignored).
 *
 ...
 */
public class CustomDIMACSImporter<V, E> extends BaseEventDrivenImporter<V, E> implements GraphImporter<V, E> {
	/**
	 ...
	 */
	public CustomDIMACSImporter(double defaultWeight) {
		super();
