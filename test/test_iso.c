...
int main() {
    ...
    void *g1;
    jgrapht_capi_ii_graph_create(thread, 0, 0, 0, 1, 0, NULL, NULL, &g1);
    assert(jgrapht_capi_error_get_errno(thread) == 0);
    ...
    jgrapht_capi_ii_graph_add_edge(thread, g1, 0, 2, NULL);
    jgrapht_capi_ii_graph_add_edge(thread, g1, 1, 3, NULL);

    void *g2;
    jgrapht_capi_ii_graph_create(thread, 0, 0, 0, 1, 0, NULL, NULL, &g2);
    assert(jgrapht_capi_error_get_errno(thread) == 0);
    ...
    jgrapht_capi_ii_graph_add_edge(thread, g2, 2, 3, NULL);
    jgrapht_capi_ii_graph_add_edge(thread, g2, 3, 0, NULL);
    jgrapht_capi_ii_graph_add_edge(thread, g2, 0, 2, NULL);
    jgrapht_capi_ii_graph_add_edge(thread, g2, 1, 3, NULL);

    int are_iso = 0;
    void *map_it;
    jgrapht_capi_xx_isomorphism_exec_vf2(thread, g1, g2, &are_iso, &map_it);
    assert(jgrapht_capi_error_get_errno(thread) == 0);
