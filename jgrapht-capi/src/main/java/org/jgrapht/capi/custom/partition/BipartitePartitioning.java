 ...
 */
package org.jgrapht.capi.custom.partition;
...
/**
 * Algorithm for computing bipartite partitions thus checking whether a graph is
 * bipartite or not.
 *
 * <p>
...
public class BipartitePartitioning<V, E> implements PartitioningAlgorithm<V> {
	...
	public boolean isBipartite() {
		...
		try {
			// at most n^2/4 edges
			if (Math.multiplyExact(4, graph.edgeSet().size()) > Math.multiplyExact(graph.vertexSet().size(),
