 ...
 * <p>
 * For every vertex in graph its cardinality is defined as the number of its
 * neighbours, which have been already visited by this iterator. Iterator
 * chooses vertex with the maximum cardinality, breaking ties arbitrarily. For
 * more information of maximum cardinality search see: Berry, A., Blair, J.,
 * Heggernes, P. et al. Algorithmica (2004) 39: 287.
 * https://doi.org/10.1007/s00453-004-1084-3
 * <a href="http://www.ii.uib.no/~pinar/MCS-M.pdf"><i>Maximum Cardinality Search
 * for Computing Minimal Triangulations</i></a>.
 * <p>
...
public class MaximumCardinalityIterator<V, E> extends AbstractGraphIterator<V, E> {
	...
	private V current;
	/**
	 * Disjoint sets of vertices of the graph, indexed by the cardinalities of
	...
	/**
	 * Retrieves a vertex from the {@code buckets} with the maximum cardinality and
	 * returns it.
	 *
	 ...
	 *
	 * @param vertex the vertex, which has to be removed from the bucket it was
	 *               contained in.
	 * @return the cardinality of the removed vertex or -1, if the vertex wasn't
	 *         contained in any bucket.
	 */
	...
	/**
	 * Increments the cardinalities of the neighbours of the {@code vertex} by 1. If
	 * the maximum cardinality increases, increments {@code maxCardinality} by 1.
	 *
