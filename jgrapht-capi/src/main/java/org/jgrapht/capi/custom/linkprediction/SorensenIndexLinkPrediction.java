 ...
 */
package org.jgrapht.capi.custom.linkprediction;
 ...
 * \frac{2|\Gamma(u)\cap\Gamma(v))|}{k(u) +k(v)}$ where for a node $v$,
 * $\Gamma(v)$ denotes the set of neighbors of $v$ and $k(v) = |\Gamma(v)|$
 * denotes the degree of $v$.
 * </p>
 * 
 * See the following two papers:
 * <ul>
 * <li>Liben‐Nowell, David, and Jon Kleinberg. "The link‐prediction problem for
 * social networks." Journal of the American society for information science and
 * technology 58.7 (2007): 1019-1031.</li>
 * <li>Zhou, Tao, Linyuan Lü, and Yi-Cheng Zhang. "Predicting missing links via
 * local information." The European Physical Journal B 71.4 (2009):
 * 623-630.</li>
 * </ul>
 * 
